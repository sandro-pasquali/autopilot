...
//	Create folder PM2 process startup configs.
//
mkdirp.sync(PM2Dir);
...
require('./questions/general.js')(config, function(general) {
	...
	//	The question is a bool, with true being prod.
	//
	var bevIsProd = general.BUILD_ENVIRONMENT;
	...
	//
 	var complete = function(a) {
		...
		config.BUILD_ENVIRONMENT = bevIsProd ? "production" : "development";
	...
	bevIsProd	? require('./questions/production.js')(config, complete) 
